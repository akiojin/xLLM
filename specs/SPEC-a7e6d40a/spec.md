...
| `ALLM_PORT` | 待受ポート | 32769 |
| `ALLM_IP` | ノードIP | (自動検出) |
| `ALLM_MODELS_DIR` | モデル保存先 | `~/.runtime/models` |
| `ALLM_LOG_LEVEL` | ログレベル | info |
| `ALLM_LOG_DIR` | ログディレクトリ | `~/.llm-router/logs` |
| `ALLM_HEARTBEAT_SECS` | ハートビート間隔 | 10 |
| `ALLM_BIND_ADDRESS` | バインドアドレス | 0.0.0.0 |
...
- 環境変数プレフィックス: Router=LLM_ROUTER_*, aLLM=ALLM_*
