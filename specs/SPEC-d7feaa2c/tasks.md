...
## プラグイン設定・互換性（Session 2025-12-31 Part 3）
- [ ] T133 プラグイン設定ファイルの自動マイグレーション実装
  - 旧フォーマット検出と新フォーマットへの変換
  - 変換失敗時のデフォルト値フォールバック
- [ ] T134 プラグイン競合時のバージョン比較ロジック実装
  - semver準拠のバージョン比較
  - 最新バージョンのプラグインを自動選択

## 動的設定変更（Session 2025-12-31 Part 3）
- [ ] T135 動的コンテキスト長変更APIの実装
  - 次リクエストからの反映
  - 処理中リクエストへの影響なし

## Tests（Session 2025-12-31 Part 3）
- [ ] T136 設定自動マイグレーションテスト
- [ ] T137 プラグインバージョン競合解決テスト
- [ ] T138 動的コンテキスト長変更テスト
